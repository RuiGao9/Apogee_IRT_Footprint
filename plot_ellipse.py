def plot_ellipse(ellipse_points, center_beam, center_x):
    '''
    Display the ellipse/cycle based on calculation.
    '''
    ...
    plt.plot(center_x, 0, 'ro', label='Ellipse Center')
    plt.plot(center_beam, 0, 'bo', label='Beam Center')
